                       ...
                       <hr />
                         <div>   
                             <asp:PasswordRecovery ID="PasswordRecovery1" runat="server">                
                                 <TitleTextStyle />
                                 <MailDefinition BodyFileName="~/Account/bienvenida.html" IsBodyHtml="True" Subject="Recuperar contraseña">
                                 </MailDefinition>
                                 <SuccessTemplate>
                                     <table cellpadding="1" cellspacing="0" style="border-collapse:collapse;">
                                         <tr>
                                             <td>
                                                 <table cellpadding="0">
                                                     <tr>
                                                         <td>Se te ha enviado tu nueva contraseña.<br />Para iniciar sesión da click <a href="Login.aspx">aquí.</a></td>
                                                     </tr>
                                                 </table>
                                             </td>
                                         </tr>
                                         ...
                                         <tr>
                                             <td>
                                                 <table cellpadding="0">
                                                     ...
                                                     <tr>
                                                         <td align="center" colspan="2" style="">Escribe tu nombre de usuario para recibir tu contraseña.</td>
                                                     </tr>
                                                     <tr>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td>
                                                             ...
                                                             <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" ErrorMessage="El nombre de usuario es obligatorio." ToolTip="El nombre de usuario es obligatorio." ValidationGroup="PasswordRecovery1" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                         </td>
                                                     </tr>
                                                     <tr>
