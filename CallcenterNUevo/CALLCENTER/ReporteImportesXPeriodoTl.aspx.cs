...
{
    public partial class ReporteImportesXPeriodoTl : System.Web.UI.Page
    {
        #region DECLARATIONS
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Master.Submenu = "Reportes Tickets";
            ...
            Master.MenuMain = "Reportes";
            Master.Submenu = "Importes por Periodo";
        }
        ...
        private void CargarReporte()
        {
            ...
            try
            {
                dataSetRegistros = reportes.ReporteImportesXPeriodoTl(hdfAnio.Value + hdfMes.Value);
        ...
        private void CargarReporteSeleccionado()
        {
            ...
            try
            {
                ...
                dataSetRegistros = reportes.ReporteTicketsXPeriodoTl(hdfAnio.Value +hdfMes.Value);
                rGrdActivaciones.DataSource = dataSetRegistros.Tables[0];
                rGrdActivaciones.DataBind();
                ...
                lblActivas.Text = string.Format("Activas: {0:N0}", dataSetRegistros.Tables[1].Rows[0]["SucursalesActivas"]);
                lblInactivas.Text = string.Format("Inactivas: {0:N0}", dataSetRegistros.Tables[1].Rows[0]["SucursalesInactivas"]);
                lblTotalActivaciones.Text = string.Format("Total de Importes: {0:N0}", dataSetRegistros.Tables[1].Rows[0]["TotalTickets"]);
                lblAzulActivaciones.Text = string.Format("BI Azul: {0:N0}", dataSetRegistros.Tables[1].Rows[0]["AzulTickets"]);
                lblPlatinoActivaciones.Text = string.Format("BI Platino : {0:N0}", dataSetRegistros.Tables[1].Rows[0]["PlatinoTickets"]);
        ...
        private void IniciarDescarga(string secuencia)
        {
            try
            {
                string nombreDocumento = string.Format("{0}_{1}_{2}.{3}", "ImportesPorPeriodo", hdfMes.Value + hdfAnio.Value, DateTime.Now.ToString("ddMMyyyyhhmmss"), "xls");
