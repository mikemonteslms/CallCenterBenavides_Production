...
{
    public partial class ReporteTicketsXPeriodoTl : System.Web.UI.Page
    {
        #region DECLARATIONS
        ...
        private void CargarReporteSeleccionado()
        {
            ...
            try
            {
                ...
                lblTotalActivaciones.Text = string.Format("Total de Tikets: {0:N0}", dataSetRegistros.Tables[1].Rows[0]["TotalTickets"]);
        ...
        private void IniciarDescarga(string secuencia)
        {
            try
            {
                string nombreDocumento = string.Format("{0}_{1}_{2}.{3}", "TicketsPorPeriodo", hdfMes.Value + hdfAnio.Value, DateTime.Now.ToString("ddMMyyyyhhmmss"), "xls");
