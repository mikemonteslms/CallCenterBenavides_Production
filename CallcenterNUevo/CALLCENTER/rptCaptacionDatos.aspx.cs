...
{
    public partial class rptCaptacionDatos : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Master.Submenu = "Captación datos";
        }

        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            RadGrid1.DataSource = Tarjetas.ConsultarCaptacion();
            RadGrid1.DataBind();
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            //RadGrid1.ExportSettings.FileName = "rptTraspasos_" + DateTime.Now.AddDays(-1 * ((int)DateTime.Now.DayOfWeek - 1)).ToShortDateString();
            //RadGrid1.MasterTableView.ExportToExcel();
            DataSet dtsDatos = Tarjetas.ConsultarCaptacion();
        ...
        private void IniciarDescarga(string secuencia)
        {
            try
            {
                string nombreDocumento = string.Format("{0}_{1}{2}{3}.{4}", "rptCaptacionDatos", DateTime.Now.Day.ToString(), DateTime.Now.Month.ToString(), DateTime.Now.Year.ToString(), "xls");
