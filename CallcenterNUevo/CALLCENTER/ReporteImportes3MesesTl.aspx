<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteImportes3MesesTl.aspx.cs" Inherits="WebPfizer.LMS.eCard.ReporteImportes3MesesTl" %>
                    ...
                    <div id="fondo" style="background-image: url(Imagenes_Benavides/acceso-registro-header.jpg);
                        ...
                        <asp:Panel ID="pnlReporteActivaciones" runat="server" Height="100%">
                            <div style="padding: 20px 78px;margin-left:-50px">
                                <asp:Label ID="lblTutulo" runat="server" CssClass="titulo" style="margin-left:-270px" Height="50px" Text="IMPORTES POR TRIMESTRE"></asp:Label>
                                <br /><br />
                                        ...
                                        <MasterTableView ShowFooter="True" AutoGenerateColumns="False" >
                                            <ColumnGroups>
                                                ...
                                                <telerik:GridColumnGroup Name="Platino" HeaderText="BI PLATINO" HeaderStyle-CssClass="headerGris"
                                                    HeaderStyle-Font-Bold="true" />
                                                <telerik:GridColumnGroup Name="Total" HeaderText="TOTAL IMPORTES" HeaderStyle-CssClass="headerVerde"
                                                    HeaderStyle-Font-Bold="true" />
                                            </ColumnGroups>
                                            <Columns>
