...
{
    public partial class rptBloqueos : System.Web.UI.Page
    {
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            rgResultado.ExportSettings.FileName = "rptBloqueos_" + DateTime.Now.Day + DateTime.Now.Month + DateTime.Now.Year;
        ...
        protected void btnConfirma_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('No se puede realizar la operación, ya que la tarjeta se encuentra en el estatus seleccionado.');", true);
                return;
            }
            else
            {
                ...
                Response.AddHeader("REFRESH", "2;URL=rptBloqueos.aspx");
            }
