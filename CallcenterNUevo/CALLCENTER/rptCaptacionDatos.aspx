<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rptCaptacionDatos.aspx.cs" Inherits="CallcenterNUevo.CALLCENTER.rptCaptacionDatos" %>
    ...
    <center>
        <div id="fondo" style="background-image: url(Imagenes_Benavides/acceso-registro-header.jpg);
            ...
            <asp:Panel ID="Panel2" runat="server" >
                <div>
                    <span class="titulo">Captación de datos</span><br /><br />
                </div>
                <div>
