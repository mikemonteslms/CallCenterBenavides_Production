...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <center>
        <div id="title" class="titulo">Saldo</div><br /><br />
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="Label5" runat="server" Text="Movimientos de la Tarjeta: " Font-Bold="True"
                                    Font-Names="Arial" ForeColor="#004A99" Font-Size="10pt"></asp:Label>
                                <br />
                                <asp:Panel ID="Panel1" runat="server"  ScrollBars="Vertical" Font-Size="12px"
                                    Height="210px">
                                    <asp:GridView ID="grvSaldoClienteCC" runat="server" Font-Names="Arial" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Fecha">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Fecha") %>' Width="100px"></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("Fecha") %>' Width="100px"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Sucursal">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("NombreSucursal") %>' Width="150px"></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("NombreSucursal") %>' Width="150px"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Producto">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox21" runat="server" Text='<%# Bind("ProductoNombre") %>' Width="200px"></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label21" runat="server" Text='<%# Bind("ProductoNombre") %>' Width="200px"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Puntos en Pesos" ItemStyle-HorizontalAlign="Right">
                                                <EditItemTemplate>
