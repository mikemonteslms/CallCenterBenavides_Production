<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteImportesXPeriodoTl.aspx.cs" Inherits="WebPfizer.LMS.eCard.ReporteImportesXPeriodoTl" %>
                ...
                <asp:UpdatePanel ID="uppReportes" runat="server">
                    <ContentTemplate>
                        ...
                        <table width="95%" border="0">
                            <tr align="center">
                                <td><asp:Label ID="lblTutulo" runat="server" CssClass="titulo" Text="Reporte de importes por periodo"></asp:Label></td>
                            </tr>
                        </table>
                        <center>
                        <br />
                        ...
                        <telerik:RadGrid RenderMode="Lightweight" ID="rGrdActivaciones" runat="server" 
                            ...
                            <MasterTableView ShowFooter="True" AutoGenerateColumns="False" >
                                <ColumnGroups>
                                    ...
                                    <telerik:GridColumnGroup Name="Total" HeaderText="TOTAL IMPORTES POR DÍA"
                                        HeaderStyle-HorizontalAlign="Center" />
                                    <telerik:GridColumnGroup Name="Azul" HeaderText="IMPORTES BI AZUL"
                                        HeaderStyle-HorizontalAlign="Center" />
                                    <telerik:GridColumnGroup Name="Platino" HeaderText="IMPORTES BI PLATINO"
                                        HeaderStyle-HorizontalAlign="Center" />
                                </ColumnGroups>
                                <Columns>
