<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteActivacion3MesesTl.aspx.cs" Inherits="WebPfizer.LMS.eCard.ReporteActivacion3MesesTl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <center>
        <div class="titulo">Reporte de Activación</div>
                    ...
                    <div id="fondo" style="background-image: url(Imagenes_Benavides/acceso-registro-header.jpg);
                        ...
                        <asp:Panel ID="pnlReporteActivaciones" runat="server" Height="100%">
                            <div style="padding: 20px 78px;margin-left:-50px">
                                <asp:Label ID="lblTutulo" runat="server" CssClass="titulo" style="margin-left:-270px" Height="50px" Text="ACTIVACIONES POR TRIMESTRE"></asp:Label>
                                <br /><br />
                                        ...
                                        <MasterTableView ShowFooter="True" AutoGenerateColumns="False" >
                                            <ColumnGroups>
                                                ...
                                                <telerik:GridColumnGroup Name="Platino" HeaderText="BI PLATINO" HeaderStyle-CssClass="headerGris"
                                                    HeaderStyle-Font-Bold="true" />
                                                <telerik:GridColumnGroup Name="Total" HeaderText="TOTAL ACTIVACIONES" HeaderStyle-CssClass="headerVerde"
                                                    HeaderStyle-Font-Bold="true" />
                                            </ColumnGroups>
                                            <Columns>
