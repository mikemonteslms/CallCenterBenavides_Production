<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteTicketsXPeriodoTl.aspx.cs" Inherits="WebPfizer.LMS.eCard.ReporteTicketsXPeriodoTl" %>
                ...
                <asp:UpdatePanel ID="uppReportes" runat="server">
                    <ContentTemplate>
                        ...
                        <table width="95%" border="0">
                            <tr align="center">
                                <td><asp:Label ID="lblTutulo" runat="server" CssClass="titulo" Text="Reporte de tickets por periodo"></asp:Label></td>
                            </tr>
                        </table>
                        <center>
                        <br />
                        ...
                        <telerik:RadGrid RenderMode="Lightweight" ID="rGrdActivaciones" runat="server" 
                            ...
                            <MasterTableView ShowFooter="True" AutoGenerateColumns="False" >
                                <ColumnGroups>
                                    ...
                                    <telerik:GridColumnGroup Name="Total" HeaderText="TOTAL TICKETS POR DÍA"
                                        HeaderStyle-HorizontalAlign="Center" />
                                    <telerik:GridColumnGroup Name="Azul" HeaderText="TICKETS BI AZUL"
                                        HeaderStyle-HorizontalAlign="Center" />
                                    <telerik:GridColumnGroup Name="Platino" HeaderText="TICKETS BI PLATINO"
                                        HeaderStyle-HorizontalAlign="Center" />
                                </ColumnGroups>
                                <Columns>
