<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EdicionNM.aspx.cs" Inherits="CallcenterNUevo.AdminMecanicas.EdicionNM" %>
   ...
   <style type="text/css">
                ...
                <table class="Grid">
                    ...
                    <asp:Repeater runat="server" ID="rptPiezas">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <input type="text" id="hdnCantPieza" value="<%# DataBinder.Eval(Container.DataItem, "Cantidad") %>" style="width:50px;" class="numeric" />
                                </td>
                                <td>
                ...
                <table class="Grid">
                    ...
                    <asp:Repeater runat="server" ID="rptBeneficio">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <input type="text" id="hdnCantBeneficio" value="<%# DataBinder.Eval(Container.DataItem, "Cantidad") %>" style="width:50px;" class="numeric" />                                    
                                </td>
                                <td>
                                    <%# DataBinder.Eval(Container.DataItem, "DescripcionProducto") %>
                                </td>
    ...
    <script>
        ...
        function ObtenerValores() {
            ...
            cP.val($("#hdnCantPieza").val());
            cB.val($("#hdnCantBeneficio").val());



            if (cP.val() < 1) {
                alert('Capture el número de piezas por favor.');
                return false;
            }
            if (cB.val() < 1) {
                alert('Capture el número de beneficios por favor.');
                return false;
            }
