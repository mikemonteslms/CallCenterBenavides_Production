<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Lista.aspx.cs" Inherits="CallcenterNUevo.AdminMecanicas.Lista" %>
 ...
 <link rel="stylesheet" href="../Content/themes/base/jquery.ui.core.css"/>
    ...
    <table>
         <tr style="border-bottom:2px solid black;">
            ...
            <td colspan="1" style="text-align:right;">
                <asp:Button Text="Cancelar" runat="server" ID="Button1" OnClick="btnCancelar_Click" /> 
                <input type="button" name="btnSiguiente" value="Siguiente" onclick="ObtenerSeleccion();" />               
                <asp:Button Text="Siguiente" runat="server" ID="Button2"  OnClick="btnSiguiente_Click" style="display:none;" /> 
                <asp:Button Text="Limpiar" runat="server" ID="Button3" OnClick="Button3_Click" /> 
            </td>
        </tr>
        <tr>
    ...
    <div id="divPlantillaProducto" style="display: none;">
        <div class="itemProd" style="display: list-item;">
            <table>
                <tr>
                    <td>
                        <input type="checkbox" id="chk###" style="width: 10px;" class="###Cat" onchange="Habilita(this)" />
                    </td>
                    <td>
    ...
    <script>
        ...
        function ObtenerSeleccion() {
            ...
            if (numPresSel < 1) {
                ...
                for (iP = 0 ; iP < numPresSel; iP++) {
                    ...
                    if (txtCantidad.val() == '' || txtCantidad.val() < 1) { alert('Capture una cantidad para cada producto por favor.'); break; }
        ...
        function EnviarInfoProductos(Seleccion) {
            ...
            $.ajax({
                type: "POST",
                url: "Lista.aspx/GuardarProductos",
                data: JSON.stringify(objBusqueda),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    if (response.d != undefined) {
                        //alert('Ok!');
                        document.getElementById("ctl00_ctl00_ContentPlaceHolder1_body_contenido_Button2").click();
