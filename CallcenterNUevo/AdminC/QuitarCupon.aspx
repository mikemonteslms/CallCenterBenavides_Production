<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuitarCupon.aspx.cs" Inherits="CallcenterNUevo.AdminC.QuitarCupon" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <center><br /><br />
        <div id="title" class="titulo">Quitar cupón</div><br /><br />
        ...
        <asp:Panel ID="pnlDatos" runat="server">
            <div style="width:650px; margin-left:-100px"><asp:HiddenField ID="hdnId" runat="server" />
                <h4 style="margin-left: -100px">Datos del cupón a quitar: <asp:Label ID="lblCupon" runat="server"></asp:Label></h4>
            </div>
            <br /><br />
            <table class="Texto" style="padding: 5px 5px 5px 5px; width:550px; text-align:left;">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><asp:Label ID="lblDescuento" runat="server" Visible="false"></asp:Label></td>
                </tr>
                 <tr>
        ...
        <asp:Panel ID="pnlAsignacion" runat="server">
            <div style="width:650px; margin-left:-100px"><asp:HiddenField ID="HiddenField1" runat="server" />
                <h4 style="margin-left: -170px">Quitar el cupón: <asp:Label ID="lblCupon2" runat="server"></asp:Label></h4>
            </div>
            <table class="Texto" style="padding: 5px 5px 5px 5px; width:650px; text-align:left;">
              ...
              <%--  <tr>
                ...
                <tr>                    
                    <td colspan="2" style="text-align:center;"><asp:Button runat="server" ID="btnCancelar" Text="Cancelar" CausesValidation="false" Width="150px" OnClick="btnCancelar_Click"/> 
                     &nbsp;&nbsp;<asp:Button ID="btnContinuaQuitar" runat="server" Text="Continuar" style="width:150px" ValidationGroup="Asignacion" OnClick="btnContinuaQuitar_Click1" Width="150px"/></td>
                </tr>
            </table>
        </asp:Panel>
    </center>
