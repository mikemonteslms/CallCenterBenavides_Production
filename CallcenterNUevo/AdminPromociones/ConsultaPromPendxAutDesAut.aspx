<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master"  CodeBehind="ConsultaPromPendxAutDesAut.aspx.cs" Inherits="CallcenterNUevo.AdminPromociones.ConsultaPromPendxAutDesAut" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br /> <br />
    <asp:Label runat="server" ID="lblTitulo" Text="Autorizar o desautorizar(promociones)"  Font-Size="16px" ForeColor="DarkBlue"/>
