<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AltaPromocionACDineroEntregaPzaz.aspx.cs" Inherits="CallcenterNUevo.AdminPromociones.AltaPromocionACDineroEntregaPzaz" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label runat="server" ID="lblTitulo" Text="Alta Promociones Acumula Dinero entrega Pieza"  Font-Size="16px" ForeColor="DarkBlue"/>
        ...
        <!--<asp:Panel runat="server" ID="pnlAltaProm" ScrollBars="Auto" Width="100%" Height="100%" > -->
            <asp:Table ID="tblDtealle" runat="server" HorizontalAlign="Center"   Width="950px" Height="100%">
                        <asp:TableRow>
                            ...
                            <asp:TableRow >
                                <asp:TableCell >
                                    <asp:Label ID="lblNomProdMM" runat="server" Text="Nombre de la Promoción: "  Width="150px" Visible="false"></asp:Label>
                                </asp:TableCell>
                                    <asp:TableCell >
                                    <asp:TextBox ID="txtNomProdACDinero" runat="server" Width="300px" Visible="false"></asp:TextBox>
                                </asp:TableCell >
                            </asp:TableRow>
                ...
                <%-- Listado #1 --%>
                            ...
                            <asp:GridView  ID="grvProd"  runat="server" CssClass="gridview"  OnRowDeleting="grvProd_RowDeleting"  OnRowDataBound="grvProd_RowDataBound"  CellSpacing ="1" AutoGenerateColumns ="false"   CellPadding="3" GridLines="Horizontal" HorizontalAlign="left" Visible="true" Enabled="false"  Width ="600px"  Height="100%" Caption="Productos"  >
                ...
                <%--  Listado #2 --%>
                            ...
                            <asp:GridView  ID="grvProd2"  runat="server" CssClass="gridview"  OnRowDeleting="grvProd2_RowDeleting" OnRowDataBound="grvProd2_RowDataBound" CellSpacing ="1" AutoGenerateColumns ="false"   CellPadding="3" GridLines="Horizontal" HorizontalAlign="left"  Width ="600px" Visible="true" Enabled="false" Height="100%" Caption="Productos B"  >
                                    <HeaderStyle ForeColor="Black"   />
                                        <Columns>
                                            <asp:TemplateField  HeaderStyle-HorizontalAlign="Center" HeaderStyle-BackColor="DarkBlue" HeaderStyle-ForeColor="White">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <%-- combo --%>
                                                    <asp:TextBox ID="txtcod2" runat="server" Text='<%# Eval("CodigoInterno")%>' AutoPostBack="true" MaxLength="8" OnTextChanged="txtcod2_TextChanged"></asp:TextBox>
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="txtcod2">
                                                    </cc1:FilteredTextBoxExtender>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                <asp:TemplateField  HeaderStyle-HorizontalAlign="Center" HeaderStyle-BackColor="DarkBlue" HeaderStyle-ForeColor="White">
                                                ...
                                                <ItemTemplate>
                                                        <asp:TextBox ID="TextBox1" runat= "server" Text='<%# Eval("IdCat")%>'  Width="100px" Enabled="false"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"  HeaderStyle-BackColor="DarkBlue" HeaderStyle-ForeColor="White">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Eval("NomProducto")%>' Enabled="false"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-BackColor="DarkBlue" HeaderStyle-ForeColor="White">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Table ID="Table1" runat="server">
                                                        <asp:TableRow>
                                                            <asp:TableCell>
                                                                <asp:Label ID="Label1" runat= "server" Text='<%# Eval("IdLaboratorio")%>' Visible="false"></asp:Label>
                                                                <telerik:RadComboBox ID="RadComboBox1" RenderMode="Lightweight" AllowCustomText="true" Filter="Contains" MarkFirstMatch="true"  DataValueField='<%# Eval("IdLaboratorio")%>'  DataTextField='<%# Eval("Laboratorio")%>'  runat="server"  Width="260px">
                                                                </telerik:RadComboBox>
                                                            </asp:TableCell>
                                                            <asp:TableCell>
                                                                <asp:Button ID="Button1" runat="server" Text="..." OnClick="btnAddLab_Click" Width="32px" ToolTip="Agregar nuevo laboratorio" Visible="true"/>
                                                            </asp:TableCell>
                                                        </asp:TableRow>
                                                    </asp:Table>
                            ...
                            <asp:TableCell VerticalAlign="Bottom">
                                <asp:Button ID="btnAgregar2" runat="server" Text="Nuevo elemento" OnClick="btnAgregar2_Click"  Width="150px" Visible="false"  />
                            </asp:TableCell>
                        </asp:TableRow> 
                            ...
                            <asp:TableCell Height="38px">
                                <asp:TextBox ID="txtCantcompra" runat="server" Height="25px"  TabIndex="7" Enabled="false"></asp:TextBox>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Height="38px">
                                    <asp:TextBox ID="txtCantentrega" runat="server" AutoPostBack="true" Height="25px" OnTextChanged="txtCantentrega_TextChanged" TabIndex="8" Enabled="false"></asp:TextBox>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Height="38px">
                                    <telerik:RadComboBox ID="rcbLimPeriodo" AutoPostBack="true" RenderMode="Lightweight"  AllowCustomText="true" Filter="Contains" MarkFirstMatch="true"    runat="server"   OnSelectedIndexChanged="rcbLimPeriodo_SelectedIndexChanged"  Width="260px"  TabIndex="0"  Enabled="false" >
                                    </telerik:RadComboBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            ...
                            <asp:TableCell Height="38px">
                                    <asp:TextBox ID="txtlimcantidad" runat="server" AutoPostBack="true" Height="25px"  Enabled="false" OnTextChanged="txtlimcantidad_TextChanged"></asp:TextBox>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell Height="38px">
                                <telerik:RadDatePicker ID="rdpFSolicitud" runat="server" AutoPostBack="true" Culture="es-MX" RenderMode="Lightweight"  OnSelectedDateChanged="rdpFSolicitud_SelectedDateChanged" Width="140px"  Enabled="false" ></telerik:RadDatePicker>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                                <asp:TableCell Height="38px">
                            ...
                            <asp:TableCell Height="38px">
                                <telerik:RadDatePicker ID="rdpFIni" runat="server" AutoPostBack="true" Culture="es-MX" RenderMode="Lightweight"  OnSelectedDateChanged="rdpFIni_SelectedDateChanged" Width="140px" Enabled="false" ></telerik:RadDatePicker>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                                <asp:TableCell Height="38px">
                            ...
                            <asp:TableCell Height="38px">
                                <telerik:RadDatePicker ID="rdpFFin" AutoPostBack="true" runat="server" Culture="es-MX" RenderMode="Lightweight"  OnSelectedDateChanged="rdpFFin_SelectedDateChanged" Width="140px" Enabled="false" ></telerik:RadDatePicker>
                            </asp:TableCell>
                        </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell Height="38px">
                            ...
                            <asp:TableCell Height="38px">
                                <telerik:RadDatePicker ID="rdpFConteo" runat="server" AutoPostBack="true" Culture="es-MX" RenderMode="Lightweight"  OnSelectedDateChanged="rdpFConteo_SelectedDateChanged" Width="140px" Enabled="false" ></telerik:RadDatePicker>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                        ...
                        <asp:TableRow >
                                <asp:TableCell  Height="38px" HorizontalAlign="left" ColumnSpan="2">
                                <asp:Panel ID="pnlExtencion" runat="server" Visible="true"  HorizontalAlign="Left" Width="350px">
                                    <asp:Table ID="tblExt" runat="server">
                                        <asp:TableRow>
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:CheckBox ID="chkAplicaExt" runat="server" AutoPostBack ="true" Text="Aplicar extensión" TextAlign="Right" OnCheckedChanged="chkAplicaExt_CheckedChanged" Visible="true" Enabled="false"/>
                                            </asp:TableCell>
                                        </asp:TableRow>
                                        <asp:TableRow>
                                            <asp:TableCell>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell>
                                    <asp:TextBox ID="txtComentario" runat="server" MaxLength="150"  Width="400px" Height="70px"  onkeypress="return isokmaxlength(event,this,150);" TextMode="MultiLine" TabIndex="9" Enabled="false" ></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell ColumnSpan="2">
                                    ...
                                    <div class="demo-container no-bg">
                                        ...
                                        <asp:MultiView ID="mvCatLab" runat="server" ActiveViewIndex="0">
                                            ...
                                            <asp:View ID="vEditaLab" runat="server">
                                                ...
                                                <asp:TableRow>
                                                <asp:TableCell>
                                                <asp:Label runat="server" ID="label3" Text="Nombre de Laboratorio:" ></asp:Label>
                                                </asp:TableCell>
                                                <asp:TableCell>
