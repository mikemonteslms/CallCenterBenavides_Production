<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MuestraDatosAutDesAutACDineroEntregaPzas.aspx.cs" Inherits="CallcenterNUevo.AdminPromociones.MuestraDatosAutDesAutACDineroEntregaPzas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br /><br />
    <asp:Label runat="server" ID="lblTitulo" Text="Promoción acumula dinero por autorizar o desautorizar"  Font-Size="16px" ForeColor="DarkBlue"/>
    <br />
            ...
            <asp:Table ID="tblDtealle" runat="server" HorizontalAlign="Center"  Width="950px" Height="100%">
                <asp:TableRow>
                    ...
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="Right">
                        ...
                        <asp:TableRow >
                                <asp:TableCell >
                                    <asp:Label ID="lblNomProdMM" runat="server" Text="Nombre de la Promoción: "  Width="150px" Visible="true"></asp:Label>
                                </asp:TableCell>
                                <asp:TableCell >
                                    <asp:TextBox ID="txtNomProdACDinero" runat="server" Width="300px" Visible="true" Enabled="false"></asp:TextBox>
                                </asp:TableCell >
                       </asp:TableRow>
                                            ...
                                            <asp:TemplateField  HeaderStyle-HorizontalAlign="Center" HeaderStyle-BackColor="DarkBlue" HeaderStyle-ForeColor="White">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="lblIdCat" runat= "server" Text='<%# Eval("Categoria")%>' Width="100px"></asp:TextBox>
                                                        <%--<asp:TextBox ID="txtCat" runat= "server" Text='<%# Eval("Categoria")%>'  Width="100px" Enabled="false"></asp:TextBox>--%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"  HeaderStyle-BackColor="DarkBlue" HeaderStyle-ForeColor="White">
                                                <HeaderTemplate>
                                        ...
                                        <Columns>
                                            <asp:TemplateField  HeaderStyle-HorizontalAlign="Center" HeaderStyle-BackColor="DarkBlue" HeaderStyle-ForeColor="White">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <cc1:FilteredTextBoxExtender ID="ftbeCodInterno" runat="server" FilterType="Numbers" TargetControlID="txtcod2">
                                                    </cc1:FilteredTextBoxExtender>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                <asp:TemplateField  HeaderStyle-HorizontalAlign="Center" HeaderStyle-BackColor="DarkBlue" HeaderStyle-ForeColor="White">
