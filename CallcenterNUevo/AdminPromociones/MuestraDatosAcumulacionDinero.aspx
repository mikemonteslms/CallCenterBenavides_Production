<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MuestraDatosAcumulacionDinero.aspx.cs" Inherits="CallcenterNUevo.AdminPromociones.MuestraDatosAcumulacionDinero" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br /><br />
    <asp:Label runat="server" ID="lblTitulo" Text="Información de la promoción acumula dinero"  Font-Size="16px" ForeColor="DarkBlue"/>
            ...
            <asp:Panel runat="server" ID="pnlMuestraDatos" ScrollBars="Auto">
                <asp:Table ID="tblDtealle" runat="server" HorizontalAlign="Center" CellSpacing="12" CellPadding="8"  Width="1100px" Height="100%">
                 ...
                 <asp:TableRow>
                    <asp:TableCell ColumnSpan="2">
                         <br />
                        <asp:Table ID="tblbotonesMod" runat="server">
                            <asp:TableRow >
                                <asp:TableCell>
