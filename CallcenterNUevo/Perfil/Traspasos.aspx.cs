...
namespace CallcenterNUevo.Perfil
{
    public partial class Traspasos : System.Web.UI.Page
    {
        ...
        {
            rgResultado.DataSource = Tarjetas.ConsultarTraspasos("0", "0", txtTarjeta.Text, "0");
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            IniciarDescarga(ExportarCVS(Tarjetas.ConsultarTraspasos("0", "0", txtTarjeta.Text, "")));
        ...
        private void IniciarDescarga(string secuencia)
        {
            try
            {
                string nombreDocumento = string.Format("{0}_{1}{2}{3}.{4}", "Traspasos", DateTime.Now.Day.ToString(), DateTime.Now.Month.ToString(), DateTime.Now.Year.ToString(), "xls");
