...
{
    public partial class comuenviada : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Master.Submenu = "Comunicación enviada";
            if (!Page.IsPostBack)
            {
        ...
        private void ObtenerComunicacionEnviada(string Tarjeta)
        {
            objDataset = cliente.ObtenerComunicacionEnviada(Tarjeta);
        ...
        {
            objDataset = cliente.ObtenerComunicacionEnviada(Session["strTarjeta"].ToString());
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            IniciarDescarga(ExportarCVS(cliente.ObtenerComunicacionEnviada(Session["strTarjeta"].ToString()).Tables[0]));
        ...
        private void IniciarDescarga(string secuencia)
        {
            try
            {
                string nombreDocumento = string.Format("{0}_{1}{2}{3}.{4}", "ComunicacionEnviada", DateTime.Now.Day.ToString(), DateTime.Now.Month.ToString(), DateTime.Now.Year.ToString(), "xls");
