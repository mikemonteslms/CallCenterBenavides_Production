<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BeneficiosEsp.aspx.cs" Inherits="CallcenterNUevo.Perfil.BeneficiosEsp" %>
...
<center>
    ...
    <asp:Panel ID="pnlTitulo" runat="server" >
            <div>
                <span class="titulo">Beneficios Especiales</span><br /><br />
            </div>
     </asp:Panel>
    <br />
    <asp:Panel ID="pnlInfo" runat="server">
        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" Culture="es-ES" GroupPanelPosition="Top">
