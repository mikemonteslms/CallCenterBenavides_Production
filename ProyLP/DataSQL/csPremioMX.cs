...
public class csPremioMX
{
    ...
    public csPremioMX(string premio_id)
    {
        _premio_id = premio_id;
    }
    public csPremioMX(string premio_id, string descrpcion, string url, string puntos, string cantidad)
    {
    ...
    public override bool Equals(System.Object obj)
    {
        ...
        csPremioMX p = obj as csPremioMX;
    ...
    public bool Equals(csPremioMX p)
    {
        // If parameter is null return false:
        if ((object)p == null)
        {
    ...
    public static bool operator ==(csPremioMX a, csPremioMX b)
    {
    ...
    public bool ObtenDetalle()
    {
        ...
        parametros = new List<SqlParameter>();
        parametros.Add(new SqlParameter("@premio_id", _premio_id));
        DataTable dtDetalle = database.dtConsulta("sp_consulta_premio_detalle_mx", parametros, true);
        if (dtDetalle.Rows.Count > 0)
        {
    ...
    public DataTable PremiosCategoriaMX()
    {
        database = new csDataBase();
        parametros = new List<SqlParameter>();
        parametros.Add(new SqlParameter("@categoria_premio_id", _categoria_id));
        DataSet dsDetalle = database.dsConsulta("sp_consulta_premios_x_categoria_mx", parametros, true);
        if (dsDetalle.Tables[1].Rows.Count > 0)
        {
            _categoria = dsDetalle.Tables[1].Rows[0]["descripcion_larga"].ToString();
        }
