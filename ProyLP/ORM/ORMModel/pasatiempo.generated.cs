...
namespace EntitiesModel	
{
	public partial class pasatiempo
	{
		...
		private long _categoria_pasatiempos_id;
		public virtual long categoria_pasatiempos_id
		{
			get
			{
				return this._categoria_pasatiempos_id;
			}
			set
			{
				this._categoria_pasatiempos_id = value;
			}
		}
		...
		private categoria_pasatiempos _categoria_pasatiempos;
		public virtual categoria_pasatiempos categoria_pasatiempos
		{
			get
			{
			...
			set
			{
				this._categoria_pasatiempos = value;
			}
		}
