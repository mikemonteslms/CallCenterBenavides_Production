...
{
	public partial class categoria_tipo_llamada
	{
		private long _id;
		...
		private IList<tipo_llamada> _tipo_llamada = new List<tipo_llamada>();
		public virtual IList<tipo_llamada> tipo_llamada
		{
			get
			{
				return this._tipo_llamada;
			}
		}
