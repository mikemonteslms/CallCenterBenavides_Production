...
namespace EntitiesModel	
{
	public partial class tipo_llamada
	{
		...
		private long? _categoria_tipo_llamada_id;
		public virtual long? categoria_tipo_llamada_id
		{
			get
			{
				return this._categoria_tipo_llamada_id;
			}
			set
			{
				this._categoria_tipo_llamada_id = value;
			}
		}
		...
		private categoria_tipo_llamada _categoria_tipo_llamada;
		public virtual categoria_tipo_llamada categoria_tipo_llamada
		{
			get
			{
			...
			set
			{
				this._categoria_tipo_llamada = value;
			}
		}
