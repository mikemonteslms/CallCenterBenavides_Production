...
namespace EntitiesModel	
{
	public partial class tipo_transaccion
	{
		...
		private long? _categoria_transaccion_id;
		public virtual long? categoria_transaccion_id
		{
			get
			{
				return this._categoria_transaccion_id;
			}
			set
			{
				this._categoria_transaccion_id = value;
			}
		}
		...
		private categoria_transaccion _categoria_transaccion;
		public virtual categoria_transaccion categoria_transaccion
		{
			get
			{
			...
			set
			{
				this._categoria_transaccion = value;
			}
		}
