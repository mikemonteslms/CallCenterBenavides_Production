<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/editor/terminosEdit.aspx.cs" Inherits="ORMOperacion.editor.terminosEdit"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head_contenido" runat="server">
    <link href="css/EditorContentStyleAviso.css" rel="stylesheet" type="text/css">
</asp:Content>
