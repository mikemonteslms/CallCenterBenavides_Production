<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/editor/promocionesEdit.aspx.cs" Inherits="ORMOperacion.editor.promocionesEdit"
    MasterPageFile="~/contenido.Master" ValidateRequest="false" %>

<%@ MasterType VirtualPath="~/contenido.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head_contenido" runat="server">
    <%--<link rel="stylesheet" type="text/css" href="../style/css/editor/estilos.css" />--%>
    <link href="css/EditorContentStylePromociones.css" rel="stylesheet" type="text/css">
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body_contenido" runat="server">
    ...
    <div>
        <telerik:RadEditor Height="500px" ID="RadEditor1" runat="server"
            ...
            ContentAreaCssFile="guiasEditor.css" RenderMode="Auto" EnableEmbeddedScripts="true">
            <ImageManager ViewPaths="~/images" UploadPaths="~/images" EnableImageEditor="true" ViewMode="Thumbnails" MaxUploadFileSize="10240000"/>
