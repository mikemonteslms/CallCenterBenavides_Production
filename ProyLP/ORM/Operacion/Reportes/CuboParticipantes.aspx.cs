...
{
    public partial class CuboParticipantes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Master.Submenu = "Cubo Participantes";
                InicializarFiltros();
            }
        }
        ...
        private void InicializarFiltros()
        {
            ...
            //ucFiltros.RutaMenu = "Reportes >> Cubo Participantes";
        ...
        protected void cubo_NeedDataSource(object sender, Telerik.Web.UI.PivotGridNeedDataSourceEventArgs e)
        {
            ...
            {
                cubo.DataSource = csReporteNegocio.EjecutarProcedimientoCubo(Membership.GetUser().ProviderUserKey.ToString(), "cuboparticipantes");
            }
        }
