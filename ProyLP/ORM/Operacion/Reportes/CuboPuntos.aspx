<%@ Page Title="" Language="C#" MasterPageFile="~/contenido.Master" AutoEventWireup="true" CodeBehind="CuboPuntos.aspx.cs" Inherits="ORMOperacion.Reportes.CuboPuntos" %>
                    ...
                    <tr>
                        <td>
                            <telerik:RadPivotGrid runat="server" ID="cubo" Culture="es-MX" EnableZoneContextMenu="true"
                                OnNeedDataSource="cubo_NeedDataSource" Width="1100px"
                                OnCellDataBound="cubo_CellDataBound" AllowSorting="true" AllowFiltering="true"
                                OnPivotGridCellExporting="cubo_PivotGridCellExporting">
                                <Fields>
                                    <telerik:PivotGridColumnField DataField="Categoria Transaccion" Caption="Categoria Transaccion" UniqueName="TotalE">
                                    </telerik:PivotGridColumnField>
                                    <telerik:PivotGridColumnField DataField="Tipo Transaccion" Caption="Tipo Transaccion" UniqueName="Total1">
                                    </telerik:PivotGridColumnField>
                                    <telerik:PivotGridColumnField DataField="Credito o Debito" Caption="Credito o Debito" UniqueName="Total2">
                                    </telerik:PivotGridColumnField>
                                    <telerik:PivotGridRowField DataField="Año" Caption="Año" UniqueName="Total3">
                                    </telerik:PivotGridRowField>
                                    <telerik:PivotGridRowField DataField="Mes" Caption="Mes" UniqueName="Total4" DataFormatString="{0:MMMM}">
                                        <CellTemplate>
                                            <asp:Label ID="Label1" runat="server" Text="<%# GetMonthName(Container.DataItem)%>" />
                                        </CellTemplate>
                                    </telerik:PivotGridRowField>
                                    <telerik:PivotGridAggregateField DataField="Participante" Caption="Total Participantes" UniqueName="TotalPaciente"
                                        Aggregate="Count">
                                    </telerik:PivotGridAggregateField>
                                    <telerik:PivotGridAggregateField DataField="Puntos" Caption="Total Kilómetros" UniqueName="TotalPuntos"
                                        Aggregate="Sum" DataFormatString="{0:D}">
                                    </telerik:PivotGridAggregateField>
                                </Fields>
