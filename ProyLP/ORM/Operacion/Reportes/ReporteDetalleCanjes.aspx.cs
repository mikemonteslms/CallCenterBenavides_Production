...
{
    public partial class ReporteDetalleCanjes : System.Web.UI.Page
    {

        private string nombreReporte = "reportedetallecanjes";
        ...
        private void Configuracion_Filtros()
        {
            ...
            //ucFiltros.RutaMenu = "Reportes >> Canjes";
        ...
        protected void gridResultado_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            {
                MembershipUser u = Membership.GetUser(Context.User.Identity.Name);
                CargarComboFiltro(e.Item, "rcbPremio", "descripcion", "descripcion", "premios", "Premio", u.ProviderUserKey.ToString());
            }
        }
