...
{
    public partial class CuboPuntos : System.Web.UI.Page
    {
        ...
        private void InicializarFiltros()
        {
            ...
            //ucFiltros.RutaMenu = "Reportes >> Cubo Kilómetros";
        ...
        protected void cubo_NeedDataSource(object sender, Telerik.Web.UI.PivotGridNeedDataSourceEventArgs e)
        {
            ...
            {
                cubo.DataSource = csReporteNegocio.EjecutarProcedimientoCubo(Membership.GetUser().ProviderUserKey.ToString(), "cubopuntos");
            }
        }
