<%@ Page Title="" Language="C#" MasterPageFile="~/contenido.Master" AutoEventWireup="true" CodeBehind="ReporteDetalleLlamadas.aspx.cs" Inherits="ORMOperacion.Reportes.ReporteDetalleLlamadas" %>
                        ...
                        <td>
                            <div style="overflow: auto; width: 1100px; height: 100%;">
                                <telerik:RadGrid ID="gridResultado" runat="server" EnableViewState="false"
                                    ...
                                    CellSpacing="0" AllowSorting="True" AllowPaging="true"
                                    AllowFilteringByColumn="True" PageSize="20"
                                    ...
                                    <MasterTableView CommandItemDisplay="Top" ShowGroupFooter="true">
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn UniqueName="llamada_id" DataField="llamada_id" HeaderText="llamada_id" Visible="false"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="participante_id" DataField="participante_id" HeaderText="participante_id" Visible="false"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="distribuidor" DataField="distribuidor" HeaderText="Zona" AllowFiltering="false">
                                                <ItemStyle Wrap="false" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="clave_participante" DataField="clave_participante" HeaderText="Clave" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="participante" DataField="participante" HeaderText="Nombre" ShowFilterIcon="false" FilterControlWidth="200px" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <HeaderStyle Wrap="false" />
                                                <ItemStyle Wrap="false" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridDateTimeColumn UniqueName="fecha" DataField="fecha" HeaderText="Fecha Llamada" DataFormatString="{0:dd/MM/yyyy}" FilterControlWidth="100px">
                                                <HeaderStyle Wrap="false" />
                                                <ItemStyle Wrap="false" />
                                            </telerik:GridDateTimeColumn>
                                            <telerik:GridBoundColumn UniqueName="categoria_llamada" DataField="categoria_llamada" HeaderText="Categoria De Llamada" ShowFilterIcon="false">
                                                <ItemStyle Wrap="false" />
                                                <FilterTemplate>
                                                    <telerik:RadComboBox ID="rcbCategoriaLlamada" runat="server" Width="160px" Height="100px" AutoPostBack="true" OnSelectedIndexChanged="FilterCombo_SelectedIndexChanged">
                                                    </telerik:RadComboBox>
                                                </FilterTemplate>
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="tipollamada" DataField="tipollamada" HeaderText="Tipo De Llamada" ShowFilterIcon="false">
                                                <ItemStyle Wrap="false" />
                                                <FilterTemplate>
                                                    <telerik:RadComboBox ID="rcbTipoLlamada" runat="server" Width="160px" Height="100px" AutoPostBack="true" OnSelectedIndexChanged="FilterCombo_SelectedIndexChanged">
                                                    </telerik:RadComboBox>
                                                </FilterTemplate>
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="descripcion" DataField="descripcion" HeaderText="Descripción" ShowFilterIcon="false" FilterControlWidth="200px" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn UniqueName="usuario" DataField="usuario" HeaderText="Usuario" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo"></telerik:GridBoundColumn>
                                        </Columns>
                                        <EditFormSettings>
                                    ...
                                    <ExportSettings IgnorePaging="true" FileName="ReporteDetalleLlamadas" ExportOnlyData="true">
