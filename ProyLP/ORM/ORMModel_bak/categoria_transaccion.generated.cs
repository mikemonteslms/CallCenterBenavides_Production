...
{
	public partial class categoria_transaccion
	{
		private long _id;
		...
		private long _credito_debito_id;
		public virtual long credito_debito_id
		{
			get
			{
				return this._credito_debito_id;
			}
			set
			{
				this._credito_debito_id = value;
			}
		}
		...
		private credito_debito _credito_debito;
		public virtual credito_debito credito_debito
		{
			get
			{
		...
		private IList<tipo_transaccion> _tipo_transaccion = new List<tipo_transaccion>();
		public virtual IList<tipo_transaccion> tipo_transaccion
		{
			get
			{
