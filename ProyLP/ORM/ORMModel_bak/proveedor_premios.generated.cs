...
namespace EntitiesModel	
{
	public partial class proveedor_premios
	{
		...
		private string _referencia_campania;
		public virtual string referencia_campania
		{
			get
			{
				return this._referencia_campania;
			}
			set
			{
				this._referencia_campania = value;
			}
		}
		
		private string _datos_facturacion;
		public virtual string datos_facturacion
		{
			get
			{
				return this._datos_facturacion;
			}
			set
			{
				this._datos_facturacion = value;
			}
		}
		
		private long _usuario_alta_id;
		public virtual long usuario_alta_id
		{
			get
			{
		...
		private long? _usuario_cambio_id;
		public virtual long? usuario_cambio_id
		{
			get
			{
		...
		private long? _usuario_baja_id;
		public virtual long? usuario_baja_id
		{
			get
			{
		...
		private IList<premio> _premio = new List<premio>();
		public virtual IList<premio> premio
		{
			get
			{
				return this._premio;
