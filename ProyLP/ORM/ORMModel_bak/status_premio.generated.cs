...
namespace EntitiesModel	
{
	public partial class status_premio
	{
		...
		private string _clave_rms;
		public virtual string clave_rms
		{
			get
			{
				return this._clave_rms;
			}
			set
			{
				this._clave_rms = value;
			}
		}
		
		private string _descripcion_rms;
		public virtual string descripcion_rms
		{
			get
			{
				return this._descripcion_rms;
			}
			set
			{
				this._descripcion_rms = value;
			}
		}
