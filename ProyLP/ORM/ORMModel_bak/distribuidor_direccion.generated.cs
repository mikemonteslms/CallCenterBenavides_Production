...
namespace EntitiesModel	
{
	public partial class distribuidor_direccion
	{
		...
		private long? _zona_id;
		public virtual long? zona_id
		{
			get
			{
		...
		private string _consultor_negocios;
		public virtual string consultor_negocios
		{
			get
			{
				return this._consultor_negocios;
			}
			set
			{
				this._consultor_negocios = value;
			}
		}
