        ...
        <table >
            ...
            <tr>
                <td style="text-align:left">
                    <asp:Label ID="lblTarjeta" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12pt" ForeColor="#004A99" Text="No. de Tarjeta:"></asp:Label>
                    <font color="#004A99">(</font><font color="#E42313"><b>*</b></font><font color="#004A99">)</font></td>
                <td>&nbsp;</td>
                <td style="text-align:left">
                    <asp:TextBox 
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td style="text-align:left">
                                            <asp:DropDownList ID="cmbTipoLlamada" runat="server" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="cmbTipoLlamada_SelectedIndexChanged">
                                            </asp:DropDownList>
                        </td>
            </tr>
            ...
            <tr>
                <td style="text-align:left"><asp:Label ID="lblSucursal" runat="server" Text="Sucursal:" ForeColor="#004A99" 
                            CssClass="Etiqueta" Font-Bold="True" Font-Names="Arial"></asp:Label><span
                            style="color: #004a99">(</span><font color="#E42313"><b>*</b></font><font color="#004A99">)</font></td>
                <td>&nbsp;</td>
                <td style="text-align:left">
            ...
            <tr>
                <td style="text-align:left"><asp:Label ID="lblNombre" runat="server" Text="Nombre:" ForeColor="#004A99" 
                            CssClass="Etiqueta" Font-Bold="True" Font-Names="Arial"></asp:Label><span
                            style="color: #004a99">(</span><font color="#E42313"><b>*</b></font><font color="#004A99">)</font></td>
                <td>&nbsp;</td>
                <td style="text-align:left">
            ...
            <tr>
                ...
                <td style="text-align:left">
                            ...
                            CssClass="Texto" MaxLength="30" Width="150px"></asp:TextBox>
                        </td>
            </tr>
            <tr style="display:none">
                <td style="text-align:left">
