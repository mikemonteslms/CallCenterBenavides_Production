...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link href="../Content/EstilosBenavides.css" rel="stylesheet" type="text/css" media="screen" />
    <link href="../Content/Calendar.css" rel="stylesheet" type="text/css" media="screen" />
                            ...
                            <tr>
                                <td align="right">
                                    <asp:ImageButton ID="btnCerrarSesion" runat="server" 
                                        ...
                                        onclick="btnCerrarSesion_Click" Visible="false"/>
                                </td>
                            </tr>
                        </table>
                        <br /><br />
                ...
                <asp:UpdateProgress ID="uprReportes" runat="server" AssociatedUpdatePanelID="uppReportes">
                    <ProgressTemplate>
                        ...
                        <div class="overlayContent">
                            <img src="../Imagenes/aero_light.gif" alt="Procesando" border="1" />
                        </div>
                    </ProgressTemplate>
                </asp:UpdateProgress>
            </ContentTemplate>
