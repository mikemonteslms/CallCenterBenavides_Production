...
namespace Negocio
{
    public class Transaccion
    {
        ...
        public static int InsertaLog(string Ambiente,string App,string Clase,string EventoOrMetodo,string Hilo,string TipoLog,string Usuario, string Mensaje, string Excepcion,string SP) 
        {
            try
            {
                if (Excepcion=="")
                ...
                listParameters.Add(new ParameterIn("@Ambiente", DbType.String, Ambiente));
                listParameters.Add(new ParameterIn("@App", DbType.String, App));
                listParameters.Add(new ParameterIn("@Clase", DbType.String, Clase));
                listParameters.Add(new ParameterIn("@EventoOrMetodo", DbType.String, EventoOrMetodo));
                listParameters.Add(new ParameterIn("@Hilo", DbType.String, Hilo));
                listParameters.Add(new ParameterIn("@TipoLog", DbType.String, TipoLog));
                ...
                listParameters.Add(new ParameterIn("@Excepcion", DbType.String, Excepcion));


                int Resultado = DataBase.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString, SP, (ParameterIn[])listParameters.ToArray(typeof(ParameterIn)));

                return Resultado;
            }
            catch (Exception ex)
            {
                Exception e = new Exception("Error al Ejecutar el Stored Procedure Sp_RegistraLogs", ex);
                ExceptionManager.HandleException(e, 1, 5000, 6);
                throw (e);
            }
        }
