    ...
    public class Catalogos : ConexionBD
    {
        ...
        public DataSet RegresaMenu(string parametro1)
        {
            try
            {
                ...
                DataSet ds = objSqlTransac.LlenaDatosDataSet("sp_PaginasxPerfil", parametros);               
        ...
        public DataSet DatosCatalogo(string query, string cadena)
        {
            try
            {
                ...
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_ObtenerListadoSepomex", parametrosSP);
                return objDataset;
            }
            catch (Exception ex)
            {
        ...
        public DataSet DatosCatalogoPreguntas(string query, string cadena)
        {
            try
            {
                objSqlTransac = new ClassDataSQL1();
                parametrosSP = Parametros(query, cadena);
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_ObtenerListado", parametrosSP);
                return objDataset;
            }
            catch (Exception ex)
            {
        ...
        public DataSet DatosCatalogoPromociones(string Tarjeta = "")
        {
            try
            {
                ...
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_ObtenerCatalogoPromociones_WEB", parametrosSP);
                return objDataset;
            }
            catch (Exception ex)
            {
        ...
        public DataSet DatosCatalogoDescuentoLab(string query, string filtro1, string filtro2, string filtro3 = "")
        {
            try
            {
                ...
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_ObtenerListadoLaboratios", parametrosSP);
                return objDataset;
            }
            catch (Exception ex)
            {
        ...
        public DataSet CargaComboFecha(string query)
        {
            try
            {
                ...
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_CargaCombosFecha", parametrosSP);
                return objDataset;
            }
            catch (Exception ex)
            {
        ...
        public DataSet CargaComboGenero()
        {
            ...
            {
                objSqlTransac = new ClassDataSQL1();
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_CargaComboGenero");
                return objDataset;
            }
            catch (Exception ex)
            {
        ...
        public DataSet DatosLlamada(string IDLlamada)
        {
            try
            {
                ...
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_ObtenerDatosLlamada", paramLlamada);
                return objDataset;
            }
            catch (Exception ex)
            {
        ...
        public DataSet ConsutlaMediosDeContacto()
        {
            ...
            {
            objSqlTransac=new ClassDataSQL1();
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_ConsutlaMediosDeContacto");
                return objDataset;
            }
            catch (Exception ex)
            {
