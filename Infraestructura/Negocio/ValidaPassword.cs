    ...
    public class ValidaPassword
    {
        ...
        public DataSet ValidaUsuario(string strUsuario, string strPassword, string strNombreEquipo, string strDireccionIP)
        {
            try
            {
                ...
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_ValidaPassword", parametrosSP);
                return objDataset;
            }
            catch (Exception ex)
            {
        ...
        public DataSet ObtienePassword(string strUsuario, string strFechaNac, string strCorreoElectronico)
        {
            try
            {
                ...
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_RecuperaPassword", parametrosSP);
                return objDataset;
            }
            catch (Exception ex)
            {
        ...
        public DataSet CambiaPassword(string strUsuario, string strPassword, string strIdentificador, int intTipoCambio)
        {
            try
            {
                ...
                DataSet objDataset = objSqlTransac.LlenaDatosDataSet("sp_ActualizaPassword", parametrosSP);
                return objDataset;
            }
            catch (Exception ex)
            {
