...
//            ConnectionStringSettings cs = ConfigurationManager.ConnectionStrings[connectionName];
        ...
        public static DataSet ExecuteDataSet(string connectionString, string nameStoredProcedure, ParameterIn[] arrayParametersIn)
        {
            ...
            try
            {
                ClassDataSQL1  conexion = new ClassDataSQL1();
                ...
                foreach (ParameterIn parameter in arrayParametersIn)
                {
                    SqlParameter parametro = new SqlParameter(parameter.Name, parameter.Value);
                    parametro.Direction = parameter.ParameterDirection;
                ...
                if (connectionString != null)
                {
                    ...
                    DS = conexion.LlenaDatosDataSet(nameStoredProcedure, lstparametros.ToArray());//db.ExecuteDataSet(dbCommand);
        ...
        public static DataSet ExecuteDataSet(string connectionString, string nameStoredProcedure, ParameterIn[] arrayParametersIn, string tipo)
        {
            DataSet DS = new DataSet();
            try
            {
                ...
                DS = conexion.LlenaDatosDataSet(connectionString, nameStoredProcedure, lstparametros.ToArray());//db.ExecuteDataSet(dbCommand);
        ...
        public static DataSet pfizer(string connectionString, string nameStoredProcedure, ParameterIn[] arrayParametersIn)
        {
            try
            {
                ...
                return conexion.LlenaDatosDataSet(nameStoredProcedure, lstparametros.ToArray());//db.ExecuteDataSet(dbCommand);
        ...
        public static DataSet ExecuteDataSet(string connectionString, string nameStoredProcedure)
        {
            try
            {
                ...
                //    parametro.Direction = parameter.ParameterDirection;
                //}
                return conexion.LlenaDatosDataSet(nameStoredProcedure,null);//db.ExecuteDataSet(dbCommand);
                //Database db;
                //if(string.IsNullOrEmpty(connectionString))
                //    connectionString = "ConnectionString";
        ...
        public static int ExecuteNonQuery(string connectionString, string nameStoredProcedure, ParameterIn[] arrayParametersIn)
        {
            try
            {
                ...
                return conexion.EjecutaStoreNonqueryint(connectionString,nameStoredProcedure, lstparametros.ToArray());//db.ExecuteDataSet(dbCommand);
                //Database db;
        ...
        /// <param name="nameStoredProcedure">Nombre del Stored Procedure a Ejecutar.</param>
        /// <param name="arrayParametersIn">Array de Parametros de Entrada.</param>
        public static int ExecuteNonQueryAdminProm(string connectionString, string nameStoredProcedure, ParameterIn[] arrayParametersIn)
        {
            try
            {
                ClassDataSQL1 conexion = new ClassDataSQL1();
        ...
        public static DataSet ExecuteQuery(string connectionString, string query)
        {
            try
            {
                ...
                return conexion.LlenaDatosDataSet(query,null);//db.ExecuteDataSet(dbCommand);
                //Database db;
