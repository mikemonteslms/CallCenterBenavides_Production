<%@ Page Title="" Language="C#" MasterPageFile="~/MasterECard.Master" AutoEventWireup="true"
    CodeBehind="BeneficioInteligenteBenavides.aspx.cs" Inherits="WebPfizer.LMS.eCard.BeneficioInteligenteBenavides" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
  ...
  m = s.getElementsByTagName(o)[0]; a.async = 1; a.src = g; m.parentNode.insertBefore(a, m)
    ...
    <asp:Panel ID="pnlComoGanarPuntos" runat="server">
        <image src="Imagenes_Benavides/informacion-BI.jpg" style='width: 641px'></image>
