<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeRep.aspx.cs" Inherits="WebPfizer.LMS.eCard.HomeRep" %>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="width: 300px">
                                            <br />
                                            <br />
                                            <asp:ImageButton ID="imgBtnCubos" runat="server" ImageUrl="~/Imagenes_Benavides/botones/del.ico.us.png"
                                                OnClick="imgBtnCubos_Click" />
                                        </td>
                                        <td style="width: 300px">
                                            <br />
                                            <br />
                                            <asp:ImageButton ID="btnCasosInusuales" runat="server" 
                                                ImageUrl="~/Imagenes_Benavides/botones/files_add.png" 
                                                onclick="btnCasosInusuales_Click" />
                                        </td>
                                        <td style="width: 200px">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Font-Names="Arial" ForeColor="White" Text="Reporte Casos Inusuales"></asp:Label>
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
