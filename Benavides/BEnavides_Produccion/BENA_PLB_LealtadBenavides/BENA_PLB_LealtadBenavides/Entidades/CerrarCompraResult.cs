...
namespace Entidades
{
    public class CerrarCompraResult
    {
        ...
        private string confirmacion_strID;
        private string cliente_intSaldoAnterior;
        private string cliente_intPuntosGanados;
        private string cliente_intSaldoActual;
        private string cliente_intSaldoActualPesos;        

        public CerrarCompraResult()
        {

        }
        public CerrarCompraResult(string tarjeta_strNumero, string codigoError_strCodigo, string codigoRespuesta_StrCodigo, string codigoRespuesta_strDescripcion, string confirmacion_strID, string cliente_intSaldoAnterior, string cliente_intPuntosGanados, string cliente_intSaldoActual, string cliente_intSaldoActualPesos)
        {
            ...
            this.confirmacion_strID = confirmacion_strID;
            this.cliente_intSaldoAnterior = cliente_intSaldoAnterior;
            this.cliente_intPuntosGanados = cliente_intPuntosGanados;
        ...
        public string Confirmacion_strID
        {
            get { return confirmacion_strID; }
            set { confirmacion_strID = value; }
        }
        ...
        public string Cliente_intPuntosGanados
        {
            get { return cliente_intPuntosGanados; }
            set { cliente_intPuntosGanados = value; }
        }
