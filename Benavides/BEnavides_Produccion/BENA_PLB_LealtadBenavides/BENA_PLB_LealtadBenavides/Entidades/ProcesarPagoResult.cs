...
namespace Entidades
{
    public class ProcesarPagoResult
    {
        ...
        private string cliente_intPuntosRedimidos;
        private string cliente_intSaldoActual;
        private string cliente_intSaldoActualPesos;

        public ProcesarPagoResult()
        {

        }
        public ProcesarPagoResult(string tarjeta_strNumero, string codigoError_strCodigo, string codigoRespuesta_StrCodigo, string codigoRespuesta_strDescripcion, string strConfirmacion, string cliente_intSaldoAnterior, string cliente_intPuntosRedimidos, string cliente_intSaldoActual, string cliente_intSaldoActualPesos)
        {
            ...
            this.cliente_intPuntosRedimidos = cliente_intPuntosRedimidos;
        ...
        {
            get { return cliente_intPuntosRedimidos; }
            set { cliente_intPuntosRedimidos = value; }
        }
