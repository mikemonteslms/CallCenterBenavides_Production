...
namespace Negocio
{
    public class Tarjetas
    {
        ...
        public Int16 ActualizaPadecimientosXTarjeta(string pTarjeta, Int16 pPadecimiento, int pPermisos, string pUsuario)
        {
            try
            {
                Int16 iResultado = 0;
        ...
        public DataSet PadecimientosXTarjeta(string pTarjeta)
        {
            ...
            {
                Exception e = new Exception("Error al Ejecutar el Stored Procedure sp_ConsutlaPadecimientosXTarjeta.", ex);
                ExceptionManager.HandleException(e, 1, 5000, 5);
                throw (e);
            }
        }
