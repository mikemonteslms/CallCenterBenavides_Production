<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteBenavidesDetallePromociones.aspx.cs"
    Inherits="Portal_Benavides.ReporteBenavidesDetallePromociones" Culture="es-MX"
    UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Label ID="lblSaldoTarjeta" runat="server" Text="Detalle de promociones" ForeColor="#004A99"
                        ...
                        <td>
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="Label5" runat="server" Text="Este reporte muestra: Detalle del histórico de promociones."
                            ...
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Font-Size="12px" CssClass="panelTablaReportes">
                                ...
                                <asp:GridView ID="grvDatos" runat="server" Font-Names="Arial" CellSpacing="3" AllowPaging="True"
                                    PageSize="4000" PagerSettings-Position="Top" EnableSortingAndPagingCallbacks="false"
