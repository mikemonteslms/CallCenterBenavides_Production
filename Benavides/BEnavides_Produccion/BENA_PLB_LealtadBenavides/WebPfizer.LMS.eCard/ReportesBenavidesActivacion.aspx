<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportesBenavidesActivacion.aspx.cs"
    Inherits="Portal_Benavides.ReportesBenavidesaActivacion" Culture="es-MX" UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Label ID="lblSaldoTarjeta" runat="server" Text="Tarjetas Activadas vs Activas y Metricas de Celular y Correo Electronico "
                            ...
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="Label5" runat="server" Text="Este reporte muestra: Tarjetas activadas, Tarjetas activas y Datos de Contacto por Estado y Sucursal."
