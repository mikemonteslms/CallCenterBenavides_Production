<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportesBenavidesTopInusuales.aspx.cs"
    Inherits="Portal_Benavides.ReportesBenavidesTopInusuales" Culture="es-MX" UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td valign="middle">
                                        <br />
                                        <asp:Label ID="lblSaldoTarjeta" runat="server" Text="Top 20 segmentos de: " ForeColor="#004A99"
                                        ...
                                        <asp:DropDownList ID="ddlReporte" runat="server" AutoPostBack="True" 
                                            ...
                                            <asp:ListItem Value="1">Top 20 por número de Tickets</asp:ListItem>
                                            <asp:ListItem Value="2">Top 20 por número de Redenciones</asp:ListItem>
                                            <asp:ListItem Value="3">Top 5 Sucursales por número de redenciones</asp:ListItem>
                                        </asp:DropDownList>
                                        &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    </td>
                                </tr>
                            ...
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="Label5" runat="server" Text="Este reporte muestra: Casos especiales de mal uso."
