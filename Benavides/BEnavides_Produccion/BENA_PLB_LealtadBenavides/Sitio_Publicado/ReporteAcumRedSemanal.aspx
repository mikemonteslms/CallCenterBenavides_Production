<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteAcumRedSemanal.aspx.cs"
    Inherits="Portal_Benavides.ReporteAcumRedSemanal" Culture="es-MX" UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Label ID="lblSaldoTarjeta" runat="server" Text="Reporte de Comité"
                            ...
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="Label5" runat="server" Text="Este reporte muestra: Ventas, Clientes, Tickets, Acumulación y Redención de productos por segmento de compra y programa. Se actualiza los Lunes de cada semana."
                                    ...
                                    <td style="width: 20%" align="left">
                                        <table>
                                            <tr>
                                                ...
                                                <td style="border-left-color: Gray; border-left-width: 1px; border-left-style: solid; vertical-align:middle">
                                                    &nbsp&nbsp
