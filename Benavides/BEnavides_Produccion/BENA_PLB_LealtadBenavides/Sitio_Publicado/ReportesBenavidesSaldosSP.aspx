<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportesBenavidesSaldosSP.aspx.cs"
    Inherits="Portal_Benavides.ReportesBenavidesSaldosSP" Culture="es-MX" UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Label ID="lblSaldoTarjeta" runat="server" Text="Reporte Saldos por Sucursal y Programa"
                            ...
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="Label5" runat="server" Text="Este reporte muestra: Saldos por Mes separados por Sucursal y Programa BI y GP"
