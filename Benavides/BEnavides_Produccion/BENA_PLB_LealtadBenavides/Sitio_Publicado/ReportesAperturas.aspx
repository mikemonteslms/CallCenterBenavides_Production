<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportesAperturas.aspx.cs"
    Inherits="Portal_Benavides.ReportesAperturas" Culture="es-MX" UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Label ID="lblSaldoTarjeta" runat="server" Text="Reporte de Aperturas" ForeColor="#004A99"
                            ...
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="Label5" runat="server" Text="Muestra Tickets y Ventas de 1030 Sucursales."
