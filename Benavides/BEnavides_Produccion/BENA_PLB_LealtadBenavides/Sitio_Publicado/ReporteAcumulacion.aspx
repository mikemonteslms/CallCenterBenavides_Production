<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteAcumulacion.aspx.cs"
    Inherits="Portal_Benavides.ReporteAcumulacion" Culture="es-MX" UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Label ID="lblSaldoTarjeta" runat="server" Text="Reporte de Acumulación"
                            ...
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="Label5" runat="server" Text="Este reporte muestra: Ventas, Acumulación y Redención de productos por categoría."
