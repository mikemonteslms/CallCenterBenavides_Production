<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteVendedores.aspx.cs"
    Inherits="Portal_Benavides.ReporteVendedores" Culture="es-MX" UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Label ID="lblSaldoTarjeta" runat="server" Text="Reporte de Vendedores"
                            ...
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="Label5" runat="server" Text="Este reporte muestra: Detalle de vendedores por sucursal y Estado con total de clientes capturados y datos de contacto válidos."
