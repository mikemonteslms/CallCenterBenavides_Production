<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportesBenavidesSemSucursal.aspx.cs"
    Inherits="Portal_Benavides.ReportesBenavidesSemSucursal" Culture="es-MX" UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Label ID="lblSaldoTarjeta" runat="server" Text="Tarjetas Entregadas, Clientes Activos vs Clientes Leales y Metricas de Celular y Correo Electronico "
                            ...
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Label ID="Label5" runat="server" Text="Este reporte muestra: Tarjetas Entregada, Clientes activos, Clientes Leales y Datos de Contacto por Sucursal."
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle; padding:4px">
                                                    ...
                                                    <br />
                                                    <asp:Label ID="Label3" runat="server" Font-Names="Arial" ForeColor="#004A99" Font-Size="8pt">Reporte Semanal</asp:Label>
                                                </td>
                                                <td style="border-left-color: Gray; border-left-width: 1px; border-left-style: solid;
                                                    ...
                                                    <br />
                                                    <asp:Label ID="Label2" runat="server" Font-Names="Arial" ForeColor="#004A99" Font-Size="8pt">Reporte Semanal</asp:Label>
                                                </td>
                                                <td style="border-left-color: Gray; border-left-width: 1px; border-left-style: solid;
                                                    vertical-align: middle; padding:4px">
                                                    <asp:ImageButton ID="ExportarMes" runat="server" Height="40px" Width="40px" ToolTip="Exportar a Excel"
                                                        ImageUrl="~/Imagenes_Benavides/botones/Excel.png" OnClick="ExportarMes_Click" />
                                                    <br />
                                                    <asp:Label ID="lnkMensual" runat="server" Font-Names="Arial" ForeColor="#004A99"
                                                        Font-Size="8pt">Reporte Mensual</asp:Label>
                                                </td>
                                                <td style="border-left-color: Gray; border-left-width: 1px; border-left-style: solid;
                                                    vertical-align: middle; padding:4px">
