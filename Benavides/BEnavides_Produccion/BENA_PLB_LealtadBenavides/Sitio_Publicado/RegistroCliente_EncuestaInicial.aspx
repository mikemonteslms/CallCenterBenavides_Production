<%@ Page Title="" Language="C#" MasterPageFile="~/MasterECard.Master" AutoEventWireup="true"
    CodeBehind="RegistroCliente_EncuestaInicial.aspx.cs" Inherits="WebPfizer.LMS.eCard.RegistroCliente_EncuestaInicial" %>
            ...
            <table width="641px" style="background-color: #EBEBEB" cellspacing="15px">
                <tr>
                    <td width="320px" align="left" valign="top">
                        <asp:Label ID="lblPadecimientos" runat="server" Text="Señala si padeces alguna enfermedad crónica:"
                        ...
                        <br />
                        <asp:Label ID="lblOtroPadecimiento" runat="server" Text="Captura Otro Padecimiento:"
                            ForeColor="#79716B" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"></asp:Label>
                        <br />
