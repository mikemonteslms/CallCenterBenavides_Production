<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportesBenavidesCasosInusuales.aspx.cs"
    Inherits="Portal_Benavides.ReportesBenavidesCasosInusuales" Culture="es-MX" UICulture="es-MX" %>
                        ...
                        <td align="center" style="height: 50px; vertical-align: text-bottom">
                            <table>
                                <tr>
                                    <td>
                                        <br />
                                        <asp:Label ID="lblTitulo" runat="server" Text="Reporte Casos Inusuales" ForeColor="#004A99"
                            ...
                            <table width="97%">
                                <tr>
                                    ...
                                    <td style="width: 70%; text-align: left">
                                        ...
                                        &nbsp
                                        <asp:Label ID="lblDescripcion" runat="server" Text="Este reporte muestra las tarjetas que por los movimientos realizados se consideran caso inusual."
                                            Font-Names="Arial" ForeColor="#004A99" Font-Size="10pt"></asp:Label>
                                        <br />
                                        <asp:Label ID="Label2" runat="server" Text="Selecciona el tipo de Caso que deseas visualizar y da clic en Buscar: "
                                            Font-Bold="True" Font-Names="Arial" ForeColor="#004A99" Font-Size="10pt"></asp:Label>
                                        &nbsp
                                        <asp:DropDownList ID="ddlTipoCaso" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlTipoCaso_SelectedIndexChanged">
                                            <asp:ListItem Selected="True" Value="0">--Selecciona--</asp:ListItem>
                                            <asp:ListItem Value="9">Todos</asp:ListItem>
                                            <asp:ListItem Value="8">Mas de 10 Productos</asp:ListItem>
                                            <asp:ListItem Value="7">Ticket Repedido</asp:ListItem>
                                            <asp:ListItem Value="6">Mas de 20 Tickets</asp:ListItem>
                                            <asp:ListItem Value="5">Mas de 5 Tickets</asp:ListItem>
                                            <asp:ListItem Value="3">Compra 5 Hr Dif</asp:ListItem>
                                            <asp:ListItem Value="2">Compra 4 Tickets</asp:ListItem>
                                            <asp:ListItem Value="1">Mas de 35 Unidades</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
